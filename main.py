...
from pydantic import BaseModel, Field          # ← Field vem do pydantic!
...
mqtt_client.tls_set()   # HiveMQ Cloud exige SSL
...
def iniciar_ciclo(body: ComandoCiclo):
    """
    Inicia o ciclo automático da bomba.
```json
    { "minutos_ligado": 15, "minutos_desligado": 45 }
```
    """
    comando = {
        "acao":              "ciclo",
